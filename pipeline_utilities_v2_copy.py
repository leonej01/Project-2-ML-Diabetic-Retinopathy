...
def model_generator(X_train, X_test, y_train, y_test):
    """
    Trains multiple models on the provided training data and evaluates them on the provided test data.
    Prints accuracy and confusion matrix for each model.
    """
    ...
    for name, model in models:
        # Create a pipeline with standard scaling and the current model
        pipeline = Pipeline([("scale", StandardScaler()), (name, model)])
